...
Для этого можно совместить [Docker Buildx Bake](https://docs.docker.com/reference/cli/docker/buildx/bake/) и [Dagger](https://dagger.io/). Bake будет отвечать за декларативное описание образов, а Dagger - за выполнение сборки, проверки и публикации. Дальше покажу реализацию на примере репозитория [container-images](https://github.com/riftonix/container-images).
